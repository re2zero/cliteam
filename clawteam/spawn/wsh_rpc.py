...
MAX_RESPONSE_SIZE = 10 * 1024 * 1024  # 10MB limit for responses
...
class WshRpcClient:
    ...
    def __init__(self, socket_path: Path | None = None):
        """Initialize RPC client with custom or default socket path."""
        self._socket_path = socket_path or self._resolve_socket_path()
        self._connected = False

    def _resolve_socket_path(self) -> Path:
        """Resolve TideTerm socket path from environment or default."""
    ...
    def send_signal(self, block_id: str, signal: str) -> bool:
        ...
        Args:
            block_id: Target block UUID.
            signal: Signal name (e.g., SIGINT, SIGTERM, SIGHUP).
    ...
    def get_block_info(self, block_id: str) -> dict | None:
        ...
        Returns:
            Block info dict or None if failed.
        """
